...
function makeNextEmailStepForCompany(company) {
    if (!company) return;
    //hent ut data fra company.email_series som er i JSON format "{"stepp1":14,"stepp2":30,"stepp3":60,"stepp4":90,"stepp5":120}" 
    ...
    //finne alle felter som starter med "stepp" i email_series
    ...
    console.log("timerunnerObject to save:", timerunnerObject);
    /*
    const nextSteppDate = new Date();
    nextSteppDate.setDate(nextSteppDate.getDate() + daystepp);
